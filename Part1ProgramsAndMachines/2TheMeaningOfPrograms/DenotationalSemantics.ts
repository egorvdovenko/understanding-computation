 ...
 * 
 * Denotational semantics is necessarily a more abstract approach than expressional, 
 * because it just replaces one language with another instead of turning a language into real
 ...
 * it expressionally by actually walking back and forth. On the other hand, if we needed
